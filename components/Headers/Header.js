...
function Header() {
  ...
  React.useEffect(async () => {
    const countDataGetResponse = await axios.get("http://65.2.142.67:3001/data/orgCount");
  ...
  React.useEffect(async () => {
    const voluntCountDataGetResponse = await axios.get("http://65.2.142.67:3001/data/voluntCount");
  ...
  React.useEffect(async () => {
    ...
    const closedCaseCountData = await axios.get("http://65.2.142.67:3001/data/totalClosedCasesCount",{
      params: {
        onlyAccepted: true,
      }
    });
  ...
  React.useEffect(async () => {
   var org = JSON.parse(localStorage.getItem("vh-org"));
   const totalCaseCountData = await axios.get("http://65.2.142.67:3001/data/TotalCasesCount",{
     params: {
       onlyAccepted: true
     }
   });
