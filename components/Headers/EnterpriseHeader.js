...
function EnterpriseHeader() {
  ...
  React.useEffect(async () => {
    ...
    const voluntCountDataGetResponse = await axios.get(`http://3.6.32.110:3001/data/orgVoluntCount/${org.Id}`);
  ...
  React.useEffect(async () => {
    var org = JSON.parse(localStorage.getItem("vh-org"));
    const closedCaseCountData = await axios.get("http://3.6.32.110:3001/data/closedCasesCount",{
      params: {
        onlyAccepted: true,
        EnterpriseId: org.Id
      }
   ...
   React.useEffect(async () => {
    var org = JSON.parse(localStorage.getItem("vh-org"));
    const activeCaseCountData = await axios.get("http://3.6.32.110:3001/data/activeCasesCount",{
      params: {
        onlyAccepted: true,
        EnterpriseId: org.Id
      }
  ...
  React.useEffect(async () => {
   var org = JSON.parse(localStorage.getItem("vh-org"));
   const totalCaseCountData = await axios.get("http://3.6.32.110:3001/data/orgTotalCasesCount",{
     params: {
       onlyAccepted: true,
       EnterpriseId: org.Id
     }
