...
const Organizations = ({sam}) => {
  ...
  const loadCaseData = async () => {
    ...
    const caseDataGetResponse = await axios.get("http://3.6.32.110:3001/data/caseDetails",{
      params: {
        onlyAccepted: true,
        EnterpriseId: org.Id
      }
  ...
  //   const postResponse = axios.post(`http://3.6.32.110:3001/data/updateCaseStat`, postData);
