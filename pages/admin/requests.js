...
const loadOrgData = async () => {
  const orgDataGetResponse = await axios.get("http://3.6.32.110:3001/data/orgData");
...
const updateStatus = async (event, idx) => {
  ...
  const postResponse = await axios.patch(`http://3.6.32.110:3001/data/updateOrgStatus/${orgData[idx].Id}`, postData);
